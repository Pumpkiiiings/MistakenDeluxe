...
object ScoreboardManager {
    ...
    private fun detectRenderer(): IScoreboardRenderer {
        ...
        return if (hasPacketEvents) {
            MistakenLib.log(MistakenLib.LogCategory.SCOREBOARD, "PacketEvents detected.")
            MistakenLib.log(MistakenLib.LogCategory.SCOREBOARD, "Advanced renderer enabled.")
            PacketEventsRenderer()
        } else {
            MistakenLib.log(MistakenLib.LogCategory.SCOREBOARD, "PacketEvents not detected.")
            MistakenLib.log(MistakenLib.LogCategory.SCOREBOARD, "Falling back to Bukkit renderer.")
            MistakenLib.log(MistakenLib.LogCategory.SCOREBOARD, "Advanced animations disabled.")
            BukkitRenderer()
        }
    }
