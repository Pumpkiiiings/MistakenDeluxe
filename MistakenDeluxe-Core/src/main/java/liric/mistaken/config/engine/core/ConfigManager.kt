...
import liric.mistaken.config.engine.sync.CharacterMigrator
import liric.mistaken.config.engine.sync.ConfigSynchronizer
import liric.mistaken.config.engine.core.MessageService
import liric.mistaken.MistakenLib

/**
 * [PUMPKING LIB]
 * ConfigManager: El patrón de las configuraciones mecánicas migrado a liric.mistaken.utils.
 */
