        ...
        if (milestone != null) {
            try {
                ...
                if (uapiPlugin != null && uapiPlugin.isEnabled) {
                    ...
                    val getInstanceMethod = uapiClass.getMethod("getInstance", Plugin::class.java)
                    ...
                    if (apiInstance != null) {
                        ...
                        if (tab != null) {
                            ...
                            if (advancement != null) {
                                val hasAdvMethod = uapiClass.getMethod("hasAdvancement", Player::class.java, Class.forName("com.frengor.ultimateadvancementapi.advancement.Advancement"))
                                val hasAdv = hasAdvMethod.invoke(apiInstance, event.player, advancement) as Boolean

                                if (!hasAdv) {
                                    val grantMethod = uapiClass.getMethod("grantAdvancement", Player::class.java, Class.forName("com.frengor.ultimateadvancementapi.advancement.Advancement"))
